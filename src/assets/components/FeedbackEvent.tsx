...
const FeedbackEvent = ({ avaliacoes, comentarios, graficosDados }) => {
  return (
    <div className="bg-white w-full flex flex-col items-start justify-start p-5 box-border gap-5 shadow-md rounded-xl">
